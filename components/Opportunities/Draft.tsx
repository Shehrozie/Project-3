...
const DraftMap: React.FC = () => {
    const draftData = [
        {
            id: 1,
            teamName: "Junior Front-End Developer",
            number: "-",
    ...
    const renderDraftData = draftData.map((copy: any, index: number) => {
        return (
                    ...
                    <div className='bg-white px-3 py-8 mb-4 mx-3 rounded-lg shadow-xl md:flex justify-between hidden'>
                        ...
                        <div className='w-1/2 flex justify-evenly items-center'>
                            ...
                            <div className='flex items-center gap-x-2'>
                                <div className='bg-yellow-400 p-2.5 rounded-full'></div>
    ...
    return (
        <>
            <div>{renderDraftData}</div>
        </>
    );

};

export default DraftMap;