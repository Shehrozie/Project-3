...
import MessageBar from "./MessageBar3";
    ...
    <div className="lg:w-1/4 w-full h-screen overflow-y-scroll bg-white border-4">
      ...
      <div className="mt-4 flex flex-col justify-center items-center gap-y-3">
        <img
          ...
          src="/img/profile_img3.png"
          alt=""
        />
        <p className="2xl:text-3xl xl:text-xl text-lg font-bold">Ryan Howard</p>
        <p className="text-gray-500 xl:text-base text-xs">Germany</p>
        ...
        <h1 className="2xl:text-4xl xl:text-xl text-lg">80% Match</h1>
        <p className="text-blue-700 xl:text-base text-xs">Project Manager</p>
      </div>
