...
import MessageBar from "./MessageBar5";
  ...
  return (
    <div className="lg:w-1/4 w-full h-screen overflow-y-scroll bg-white border-4">
      ...
      <div className="mt-4 flex flex-col justify-center items-center gap-y-3">
        ...
        <p className="text-gray-500 xl:text-base text-xs">Poland</p>
        ...
        <h1 className="2xl:text-4xl xl:text-xl text-lg">60% Match</h1>
        <p className="text-blue-700 xl:text-base text-xs">Devops Developer</p>
      </div>
