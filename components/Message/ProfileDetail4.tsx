...
import MessageBar from "./MessageBar4";
    ...
    <div className="lg:w-1/4 w-full h-screen overflow-y-scroll bg-white border-4">
      ...
      <div className="mt-4 flex flex-col justify-center items-center gap-y-3">
        <img
          ...
          alt=""
        />
        <p className="2xl:text-3xl xl:text-xl text-lg font-bold">Erin Hannon</p>
        <p className="text-gray-500 xl:text-base text-xs">Spain</p>
        ...
        <h1 className="2xl:text-4xl xl:text-xl text-lg">93% Match</h1>
        <p className="text-blue-700 xl:text-base text-xs">Software Engineer</p>
      </div>
