    ...
    const profilesData = [
        {
            ...
            notesIcon: "...",
            email: "pam@pixelandgraphcs.com",
            status: "Date Joined",
        },

        {
            id: 2,
            cardImage: "/img/user-two.jpeg",
            teamName: "Gabe Lewis",
            recruitmentAgent: "Recruitment Agent",
            dateApplied: "14/08/2019",
            notesIcon: "...",
            email: "gabe@pixelandgraphcs.com",
            status: "Date Joined",
        },
    ];


    const renderProfilesData = profilesData.map((copy: any, index: number) => {
        return (
                ...
                <div>
                    ...
                    <div className='md:flex hidden flex-col'>
                        ...
                        <div className='bg-white mx-6 mt-2 py-6 rounded-xl shadow-2xl flex justify-between items-center'>
                            ...
                            <p className='lg:text-base text-xs text-blue-600 font-bold'>{copy.email}</p>
