  ...
  return (
    <div className="w-full h-full pt-8 overflow-y-auto no-scrollbar flex justify-between">
      <form className="w-full px-4 flex flex-col" action="" method="post">
        <h1 className="font-bold text-3xl py-4">Here's What You'll Do</h1>
        <p className="text-gray-500 pb-6">
          Please provide detailed information what Talent is going to do.
        </p>
        <div className="bg-white border-2 w-full h-full">
          <RichTextEditorr />
        </div>
        <h1 className="font-bold text-3xl py-4">Opportunity Description</h1>
        <p className="text-gray-500 pb-6">
