...
const AppliedMap: React.FC = () => {
    const appliedData = [
        {
            ...
            review: "Review Talent"
        },

        {
            id: 2,
            imgName: "/img/gallery-icon.svg",
            userName: "Shehroz Ali Khan",
            notesIcon: "Front-End Developer",
            percentage: "92%",
            dateApplied: "14/08/2019",
            chatIcon: "/img/note-icon.svg",
            daysRemain: "6 Days To Respond",
            review: "Review Talent"
        },
    ...
    const renderAppliedData = appliedData.map((copy: any, index: number) => {
        return (
