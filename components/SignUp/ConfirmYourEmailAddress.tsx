      ...
      <div className="w-full p-4 flex">
        <div className="md:w-[65%] w-full">
          ...
          <form action="" className="pt-4 flex flex-col gap-y-8">
            ...
            <button
              type="button"
              className="border-2 border-blue-700 py-4 mr-8 rounded-xl text-blue-700 cursor-pointer"
            >
              Resend Code
            </button>
            <button
              type="button"
              className="bg-blue-600 py-4 mr-8 rounded-xl text-white cursor-pointer"
            >
              Confirm
            </button>
          </form>
